...
def line_bounds():
    ...
    'HEI5875':[5866, 5885], 'HALPHA':[6545, 6580], 'HEI6678':[6670, 6695]}
    return x

def abundance_dictionary():
    x = {
    'He':['HEI4026', 'HEI4143', 'HEI4387', 'HEI4471', 'HEI4713', 'HEI4922', 'HEI5016', 'HEI5048', 'HEI5875', 'HEI6678', 'HEII1640', 'HEII4200', 'HEII4541', 'HEII4686', 'HEII6406', 'HEII6527', 'HEII6683', 'HALPHA', 'HBETA', 'HGAMMA', 'HDELTA', 'HEPS'],
